...
<form method="POST" action="{{ route('candidature.store') }}" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    <label for="salaire_actuel" class="form-label">Salaire actuel</label>
    <input type="text" class="form-control" id="salaire_actuel" name="salaire_actuel">
  </div>
  <div class="mb-3">
    <label for="pretention" class="form-label">Prétentions salariales</label>
    <input type="text" class="form-control" id="pretention" name="pretention">
  </div>
  
  <button type="submit" class="btn btn-primary">Suivant</button>
</form>

<form method="POST" action="{{ route('postuler.formation', ['candidature' => $candidature->id]) }}">
  @csrf
  
  <h5>Formation</h5>
  <div class="mb-3">
    <label for="diplome" class="form-label">Diplôme / Certificat</label>
  ...
  <div class="mb-3">
    <label for="date_debut_formation" class="form-label">Date de début</label>
    <input type="date" class="form-control" id="date_debut_formation" name="date_debut_formation" required>
  </div>
  <div class="mb-3">
    <label for="date_fin_formation" class="form-label">Date de fin</label>
    <input type="date" class="form-control" id="date_fin_formation" name="date_fin_formation" required>
  </div>
  
  <button type="submit" class="btn btn-primary">Suivant</button>
</form>
<form method="POST" action="{{ route('postuler.experience') }}">
  @csrf
  ...
  <div class="mb-3">
    <label for="date_debut_experience" class="form-label">Date de début</label>
    <input type="date" class="form-control" id="date_debut_experience" name="date_debut_experience" required>
  </div>
  <div class="mb-3">
    <label for="date_fin_experience" class="form-label">Date de fin</label>
    <input type="date" class="form-control" id="date_fin_experience" name="date_fin_experience" required>
  </div>
